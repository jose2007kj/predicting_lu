...
class KerasModel( object ):
	...
	def parseTest(self,word2id):
		...
		# data = {'utterances': utterances, 'uttCount': utt_count, 'wordVocabSize' : wordVocabSize, 'id2word':id2word}
		return utterances
...
#			y = self.model.layers[9].output
	...
	def run(self):
		...
		with open('tagDictionary.json') as json_data:
		...
		with open('id2tag.json') as json_data:
		...
		H_train = H_test = H_dev = None
		self.test(H=H_test, X=X_test, data_type='test', tagDict=getIndex2Tag, pad_data=pad_X_test)
		# testData = dataSet(self.test_file, 'test', getWordVocab, getTagVocab, getIndex2Word,getIndex2Tag)
		# self,dataFile,toggle,wordDictionary,tagDictionary,id2word,id2tag
		# with open('wordDictionary.json', 'w') as the_file:
		# 	json.dump(trainData.getWordVocab(),the_file)#the_file.write(''.join(trainData))
		# with open('tagDictionary.json', 'w') as the_file1:
		# 	json.dump(trainData.getTagVocab(),the_file1)#the_file1.write(''.join(testData))
		# with open('id2word.json', 'w') as the_file2:
		# 	json.dump(trainData.getIndex2Word(),the_file2)#the_file.write(''.join(trainData))
		# with open('id2tag.json', 'w') as the_file3:
		# 	json.dump(trainData.getIndex2Tag(),the_file3)
		# print("*****",trainData.getWordVocab())
		# print("#####",trainData.getTagVocab())
		# print("$$$$$$",trainData.getIndex2Word())
		# print("______",trainData.getIndex2Tag())
		...
		# pad_X_test = sequence.pad_sequences(utterence, maxlen=self.time_length, dtype='int32', padding='pre')
